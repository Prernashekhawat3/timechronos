    ...
    def add_task(self):
        try:
            ...
            return jsonify({
                ...
                'billable_type': task.billable_type.value,
                'status': 201
            })
        except Exception as e:
            return jsonify({'message': str(e), 'status': 500}), 500
        ...
        try:
            ...
            for task in tasks:
                task_list.append({
                    ...
                    'billable_type': task.billable_type.value if task.billable_type else None
                })
        ...
        try:
            ...
            for taskhour in taskhours:
                ...
                taskhour_list.append({
                    ...
                    'billable_type': taskhour.billable_type.value if taskhour.billable_type else None
                })  
